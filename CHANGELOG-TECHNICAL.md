...
All notable changes to `forgeomni/superaicore`, in full engineering detail — class-level changes, migrations, config keys, and upgrade gotchas. For the customer-facing view of each release, see [CHANGELOG.md](CHANGELOG.md).
